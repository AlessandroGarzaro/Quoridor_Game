...
void GUI_Wall(uint16_t Xpos, uint16_t Ypos, uint8_t str,uint16_t Color, uint16_t bkColor)
{		
		char nWall ;
    uint8_t TempChar;
	
		sprintf(nWall,"%d",str);
//		GUI_Text(200, 0, (uint8_t)nWall, White, Blue);
    //PutChar( Xpos, Ypos, nWall, Color, bkColor );    
